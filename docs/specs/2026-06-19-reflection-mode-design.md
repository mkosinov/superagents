...
Каждый check маппится на Key Principle из SuperAgents README. Это self-enforcement слой.
...
| 6 workflow checks | `workflow_checks.py` | 0.5 дня |
...
## 14. Self-review checklist (для G1b)

- [x] Все 6 workflow checks описаны с SQL/pseudocode (§6)
